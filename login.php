                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Hack4i</strong> Login Form</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Enter your registered Email id and password to log on:</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="POST" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="useremail" placeholder="Enter your email-id..." class="form-username form-control" id="useremail">
			                        </div>
			                        <div class="form-group">
